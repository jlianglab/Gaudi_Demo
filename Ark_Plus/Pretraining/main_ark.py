...
def get_args_parser():
    ...
    parser.add_option("--output_dir", dest="output_dir", help="output directory", default="./", type="string")
    ...
    parser.add_option("--device", dest="device", help="cpu|cuda|hpu", default="cuda", type="string")
    ...
    parser.add_option("--torch_compile", dest="torch_compile", help="whether to use torch.compile with hpu",
...
def main(args):
    ...
    model_path = os.path.join(args.output_dir,'Models',exp_name)
    output_path = os.path.join(args.output_dir,'Outputs',exp_name)

    datasets_config = get_config('/workspace/config.yaml')
